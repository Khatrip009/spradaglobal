  ...
  return (
    <div id="hero" className="relative h-[80vh] min-h-[500px] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        {/* Description */}
        <motion.p
          className="text-xl md:text-xl text-slate-200 font-light max-w-3xl mx-auto mb-10 [text-shadow:0_0_8px_rgba(0,0,0,0.8)]"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ type: "spring", stiffness: 120, damping: 10, delay: 0.6 }}
        >
          Connecting premium Indian produce with global markets, providing end-to-end expertise for seamless international commerce.
        </motion.p>
