...
// Production default is the live API; dev localhost is a dev override
const PROD_API = "https://apisprada.exotech.co.in";
...
/* -----------------------------------------------------------
   HTTP helpers & postJson (ensures a normalized API base is used)
------------------------------------------------------------ */
